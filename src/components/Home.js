          ...
          <div>
            <div>
              ...
              <div>
                ...
                <a href="/Collin_Beczak_Resume.pdf">
                  <svg
                    className="svg-info"
                    xmlns="http://www.w3.org/2000/svg"
                    stroke="2"
      ...
      <div className="section2">
        <div className="projectsContainer">
          <div className="projects col-10 text-primary">
            ...
            <div className="projectCell">
              <h2 className="projectHeader">TicTacToe Game</h2>
              <p>January 2022</p>
              <h3>
            ...
            <div className="projectCell">
              <h2 className="projectHeader">Responsive Web Design Practice</h2>
              <p>March 2022</p>
              <h3>
            ...
            <div className="projectCell">
              <h2 className="projectHeader">Map Roulette Community Tickets</h2>
              <p>June 2022</p>
              <h3>
            ...
            <div className="projectCell">
              <h2 className="projectHeader">Personal Website</h2>
              <p>June 2022</p>
              <h3>
